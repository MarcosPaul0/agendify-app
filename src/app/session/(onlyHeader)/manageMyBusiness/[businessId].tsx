  ...
  function catchDeleteBusinessError(error: IErrorResponse) {
    switch (error.statusCode) {
      case HTTP_STATUS.INTERNAL_SERVER_ERROR:
        ...
        break;
      default:
        errorNotify('Erro ao deltar o negócio');
        break;
    }
  }
      ...
      <Container>
        <ScrollView className="w-full px-5">
          ...
          <DeleteAlert
            ...
            text="Deltar um negócio é uma ação definitiva, após a confimação todos os dados relacionado a seu negócio serão perdidos"
